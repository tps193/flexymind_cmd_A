...
public class CreditsScene extends Scene {
    ...
    private static final float CAPTIONS_POSITION_LEFT = MainActivity.TEXTURE_WIDTH * 111 / 1024;
    private static final float CAPTIONS_POSITION_UP = MainActivity.TEXTURE_HEIGHT * 15 / 110;
    private static final float DEV_POSITION_LEFT = MainActivity.TEXTURE_WIDTH * 31 / 1024;
